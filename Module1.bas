...
Function XBBファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    ...
    End Select
End Function
Function 小児XBBファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant, 前回年齢E文 As String) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種開始
            Select Case 回数
...
Function ファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    ...
    End Select
End Function
Function 小児BA5ファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant, 前回年齢E文 As String) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種終了
    ...
    End Select
End Function
Function 小児ファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant, 前回年齢E文 As String) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種終了
