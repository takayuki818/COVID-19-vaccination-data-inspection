...
Sub テスト()
    ...
    MsgBox 文
End Sub
Function 接種判定(年齢 As Variant, 接種日 As Date, ワクチン名 As String, 回数 As Long, 前回接種日 As Variant, 前回年齢E文 As String) As Variant()
    Select Case ワクチン名
    '現行ワクチン
        Case "コミナティ（ＸＢＢ．１．５）": 接種判定 = XBBファイザー判定(年齢, 接種日, 回数, 前回接種日)
        Case "コミナティ５から１１歳用ＸＢＢ．１．５": 接種判定 = 小児XBBファイザー判定(年齢, 接種日, 回数, 前回接種日)
        Case "コミナティ６か月から４歳用ＸＢＢ．１．５": 接種判定 = 乳幼児XBBファイザー判定(年齢, 接種日, 回数, 前回接種日, 前回年齢E文)
        Case "スパイクバックス（ＸＢＢ．１．５）": 接種判定 = XBBモデルナ判定(年齢, 接種日, 回数, 前回接種日)
        Case "スパイクバックス６～１１歳ＸＢＢ．１．５": 接種判定 = 小児XBBモデルナ判定(年齢, 接種日, 回数, 前回接種日)
    ...
    '終了ワクチン
        ...
        Case "ファイザー（５から１１歳用）": 接種判定 = 小児ファイザー判定(年齢, 接種日, 回数, 前回接種日)
        Case "コミナティ（５から１１歳用ＢＡ．４／５）": 接種判定 = 小児BA5ファイザー判定(年齢, 接種日, 回数, 前回接種日)
...
Function 年齢判定(年齢 As Variant, 下限 As Long, 上限 As Long) As String
    ...
    End If
End Function
Function 間隔判定(接種日 As Date, 前回接種日 As Variant, 設定値 As Long, 単位 As String) As String
    If 前回接種日 = "" Then
        間隔判定 = "前回不明"
        Exit Function
    End If
    ...
    End Select
End Function
Function XBBファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
    ...
    End Select
End Function
Function 小児XBBファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種開始
            Select Case 回数
                Case 1: 小児XBBファイザー判定 = Array(年齢判定(年齢, 5, 11), "")
                Case 2: 小児XBBファイザー判定 = Array(年齢判定(年齢, 5, 11), 間隔判定(接種日, 前回接種日, 19, "日"))
    ...
    End Select
End Function
Function 乳幼児XBBファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant, 前回年齢E文 As String) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種開始
            Select Case 回数
    ...
    End Select
End Function
Function XBBモデルナ判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
    ...
    End Select
End Function
Function 小児XBBモデルナ判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
        Case Is >= #9/25/2023# '接種開始
            Select Case 回数
    ...
    End Select
End Function
Function ノババックス判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
    ...
    End Select
End Function
Function BA5ファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
    ...
    End Select
End Function
Function BA1ファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種終了
    ...
    End Select
End Function
Function ファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種終了
    ...
    End Select
End Function
Function 小児BA5ファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種終了
        ...
        Case Is >= #8/7/2023# '1・2回目接種開始
            Select Case 回数
                ...
                Case 2: 小児BA5ファイザー判定 = Array(年齢判定(年齢, 5, 11), 間隔判定(接種日, 前回接種日, 19, "日"))
    ...
    End Select
End Function
Function 小児ファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種終了
        ...
        Case Is >= #4/1/2023# '3回目使用終了
            Select Case 回数
                ...
                Case 2: 小児ファイザー判定 = Array(年齢判定(年齢, 5, 11), 間隔判定(接種日, 前回接種日, 19, "日"))
    ...
    End Select
End Function
Function 乳幼児ファイザー判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant, 前回年齢E文 As String) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種終了
    ...
    End Select
End Function
Function BA5モデルナ判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種終了
    ...
    End Select
End Function
Function BA1モデルナ判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種終了
    ...
    End Select
End Function
Function 小児BA5モデルナ判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
        Case Is >= #9/20/2023# '接種終了
    ...
    End Select
End Function
Function モデルナ判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
    ...
    End Select
End Function
Function アストラゼネカ判定(年齢 As Variant, 接種日 As Date, 回数 As Long, 前回接種日 As Variant) As Variant()
    Select Case 接種日
